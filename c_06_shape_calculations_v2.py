...
def heron_triangle(side_a, side_b, side_c):
...
def base_height_triangle(base, height):
...
if ask_user == "yes":
    ...
    answers = heron_triangle(side_a, side_b, side_c)
    ...
    answers = base_height_triangle(base, height)
